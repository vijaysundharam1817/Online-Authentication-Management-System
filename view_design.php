...
<section class="contact-section">
    <div class="container">
         ...
         <h2 class="contact-title">Products</h2>
        <div class="row">
            <div class="col-12">
               
          <?php
			$q1=mysqli_query($connect,"select * from tt_product where uname='$uname' && post_st='0'");
			...
			?>
				...
				{
				 echo '<a href="view_design.php?act=ok&pid='.$r1['id'].'" style="color:#0066CC">Post</a>'; 
				 }
