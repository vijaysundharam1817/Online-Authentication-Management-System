...
if($act=="ok")
{
mysqli_query($connect,"update tt_product set post_st=1 where id=$pid");

?>
<script language="javascript">
alert("Postd Successfully");
window.location.href="view_bid.php";
</script>
<?php
}
...
<section class="contact-section">
    <div class="container">
         ...
         <div class="row">
          ...
          <?php
			$q1=mysqli_query($connect,"select * from tt_product where post_st=2");
			...
			?>
				...
				<td><?php
				echo '<a href="quote.php?pid='.$r1['id'].'&customer='.$r1['uname'].'" style="color:#0066CC">Quote</a> / '; 
				 echo '<a href="bidding.php?pid='.$r1['id'].'" style="color:#0066CC">View</a>'; 
