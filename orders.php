...
<section class="contact-section">
    <div class="container">
         ...
         <h3 class="contact-title">Orders</h3>
         <div class="row">
            <div class="col-12">
               
           <?php
			$q1=mysqli_query($connect,"select * from tt_product where bidder='$uname' && post_st=3");
			...
			?>
				...
				<td><?php echo $r1['commission']; ?></td>
				<td><?php echo $r1['net_amount']; ?></td>
				<td><?php echo $r1['order_date']; ?></td>
				</tr>
				<?php
				}
				?>
