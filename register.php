...
if(isset($btn))
{
$mq=mysqli_query($connect,"select max(id) from tt_customer");
$mr=mysqli_fetch_array($mq);
$id=$mr['max(id)']+1;

$qry=mysqli_query($connect,"insert into tt_customer(id,name,mobile,email,address,uname,pass) values($id,'$name','$mobile','$email','$address','$uname','$pass')");
	if($qry)
	{
	?>
...
<section class="contact-section">
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-lg-8">
                <form name="form1" class="form-contact contact_form" action="" method="post">
                    <div class="row">
