...
<section class="contact-section">
    <div class="container">
        ...
        <div class="row">
            <div class="col-12">
                <h2 class="contact-title">Order Information</h2>
            </div>
            <div class="col-lg-8">
			  <?php
			$q1=mysqli_query($connect,"select * from tt_product order by id desc");
			...
			?>
                ...
                echo '<a href="view_quote.php?pid='.$r1['id'].'" style="color:#0066CC">View</a>';
				}
