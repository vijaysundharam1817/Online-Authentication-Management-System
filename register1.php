...
if(isset($btn))
{
$mq=mysqli_query($connect,"select max(id) from ew_det");
$mr=mysqli_fetch_array($mq);
$id=$mr['max(id)']+1;

$qry=mysqli_query($connect,"insert into ew_det(id,details,sms_st,bcode,rdate,rtime) values($id,'$status','0','$bcode','$rdate','$rtime')");
	if($num==1)
	{
                    ...
                    <div class="main-menu f-right d-none d-lg-block">
                        <nav> 
                            <ul id="navigation">                                                                                                                                     
                                ...
                                <li><a href="login_user.php">Customer</a></li>
                                <li><a href="login.php">Suit Maker</a></li>
