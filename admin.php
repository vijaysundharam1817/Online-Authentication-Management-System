...
if($act=="ok")
{
$q2=mysqli_query($connect,"select * from tt_bidder where id=$tid");
$r2=mysqli_fetch_array($q2);
$un=$r2['uname'];
$name=$r2['name'];
$email=$r2['email'];
$pass=rand(10000,99999);
$message="Suit Maker: $name, Login ID: $un, Password: $pass";

echo '<iframe src="http://iotcloud.co.in/testmail/sendmail.php?message='.$message.'&email='.$email.'" style="display:none"></iframe>';
mysqli_query($connect,"update tt_bidder set status='1',pass='$pass' where id=$tid");
...
<section class="contact-section">
    <div class="container">
        ...
        <div class="row">
            <div class="col-12">
                <h2 class="contact-title">Bidder - Information</h2>
            </div>
            <div class="col-lg-8">
			<?php
			$q1=mysqli_query($connect,"select * from tt_bidder order by id desc");
			...
			?>
				...
				<td><?php echo '<a href="upload/'.$r1['proof'].'" target="_blank"><img src="upload/'.$r1['proof'].'" width="100" height="100"></a>'; ?></td>
				<td><?php
				if($r1['status']=='1')
				{
				echo "Approved";
				...
				{
				 echo '<a href="admin.php?act=ok&tid='.$r1['id'].'" style="color:#0066CC">Approve</a>'; 
				 }
