...
if($act=="ok")
{
mysqli_query($connect,"update tt_design set post_st=1 where id=$pid");
...
<section class="contact-section">
    <div class="container">
         ...
         <div class="row">
          ...
          <?php
			$q1=mysqli_query($connect,"select * from tt_product where uname='$uname' && post_st>=1");
			...
			?>
				...
				<td><a style="color:blue" href="view_productinfo.php?id=<?php echo $r1['id'];?>" title="Product Info"><?php echo $r1['itemname']; ?></a></td>
				
				<td><?php
				if($r1['post_st']=='2')
				{
				echo "Bidding Allowed"; echo "|";
                echo '<a href="view_quote1.php?pid='.$r1['id'].'" style="color:#0066CC">View</a>';
				}
