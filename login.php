...
if(isset($btn))
{
$qry=mysqli_query($connect,"select * from tt_bidder where uname='$uname' && pass='$pass' && status=1");
$num=mysqli_num_rows($qry);
	...
	{
	$msg="Invalid User! (or) not approved!";
	}
...
<section class="contact-section">
    <div class="container">
        ...
        <div class="row">
            <div class="col-12">
                <h2 class="contact-title">Bidder Login</h2>
            </div>
            <div class="col-lg-8">
                <form class="form-contact contact_form" action="" method="post">
                    ...
                    </div><a href="reg_tailor.php" style="color:#996633">New Bidder</a>
                </form>
